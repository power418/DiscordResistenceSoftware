...
extern const std::wstring_view tray_tooltip = L"software_discord_rpc is running";
extern const std::wstring_view splash_message =
  L"Discord RPC monitor active. This window will hide to tray.";
...
extern const std::string_view common_controls_manifest_dependency =
  RPC_WINDOWS_COMMON_CONTROLS_MANIFEST;
